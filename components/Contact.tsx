          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white border border-primary-100 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-warm-900/60 text-sm mt-1">
                  We are available to answer your questions anytime.<br />
            ...
            <div className="bg-white border border-primary-100 rounded-2xl p-6 flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-warm-900/60 text-sm mt-1">Very reasonable rates for the Clairemont / UTC area.<br />Contact us for a personalized quote.</p>
              </div>
            </div>
          </div>

          <div className="bg-primary-500 rounded-2xl p-8 text-white flex flex-col gap-6">
            <div>
              <h3 className="text-2xl font-bold">Ready to learn more?</h3>
              <p className="mt-2 text-white/75">Please feel free to message us anytime — we respond quickly and are happy to schedule a visit so you can see our home for yourself.</p>
            </div>
            <a
              href="https://www.facebook.com/diep.malmberg"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 bg-white text-primary-600 font-semibold py-3.5 px-6 rounded-full hover:bg-primary-50 transition-colors"
            >
